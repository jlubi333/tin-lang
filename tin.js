...
var _user$project$Model$init = {
	ctor: '_Tuple2',
	_0: {code: '', oldCode: '', output: ''},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {code: a, oldCode: b, output: c};
	});
var _user$project$Model$Run = {ctor: 'Run'};
var _user$project$Model$UpdateCode = function (a) {
	return {ctor: 'UpdateCode', _0: a};
};

var _user$project$TinLang$Boolean = function (a) {
	return {ctor: 'Boolean', _0: a};
};
var _user$project$TinLang$Number = function (a) {
	return {ctor: 'Number', _0: a};
};

var _user$project$TinParser$number = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(
		function (x) {
			return _user$project$TinLang$Number(
				{val: x});
		}),
	_elm_tools$parser$Parser$float);
var _user$project$TinParser$whitespace = function () {
	...
	return A2(_elm_tools$parser$Parser$ignore, _elm_tools$parser$Parser$zeroOrMore, isWhitespace);
}();
var _user$project$TinParser$token = F2(
	function (text, val) {
		return A2(
...
var _user$project$TinParser$boolean = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_user$project$TinParser$token,
			'true',
			_user$project$TinLang$Boolean(
				{val: true})),
		_1: {
			ctor: '::',
			_0: A2(
...
var _user$project$TinParser$exp = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
		_user$project$TinParser$whitespace),
	_elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: _user$project$TinParser$number,
			_1: {
				ctor: '::',
				_0: _user$project$TinParser$boolean,
				_1: {ctor: '[]'}
			}
		}));
var _user$project$TinParser$program = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|='],
			_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
			_user$project$TinParser$exp),
		_user$project$TinParser$whitespace),
	_elm_tools$parser$Parser$end);
var _user$project$TinParser$parse = _elm_tools$parser$Parser$run(_user$project$TinParser$program);

var _user$project$Controller$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'UpdateCode') {
			return {
				ctor: '_Tuple2',
			...
			var newOutput = _elm_lang$core$Basics$toString(
				_user$project$TinParser$parse(model.code));
			var oldCode = model.code;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{oldCode: oldCode, output: newOutput}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
...
var _user$project$ModelHelpers$isDirty = function (model) {
	return !_elm_lang$core$Native_Utils.eq(model.code, model.oldCode);
};

var _user$project$View$output = function (model) {
	var dirtyFlag = _user$project$ModelHelpers$isDirty(model) ? 'dirty' : '';
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(dirtyFlag),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View$editor = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('run-button'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$Run),
									_1: {ctor: '[]'}
								}
							},
							{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$textarea,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Model$UpdateCode),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$View$workArea = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('work-area'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$editor(model),
			_1: {
				ctor: '::',
				_0: _user$project$View$output(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$header = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('tin-lang'),
		_1: {ctor: '[]'}
	});
var _user$project$View$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$workArea(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, view: _user$project$View$view, update: _user$project$Controller$update, subscriptions: _user$project$Subscriptions$subscriptions})();
